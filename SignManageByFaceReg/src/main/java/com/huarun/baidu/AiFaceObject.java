...
public class AiFaceObject {
    ...
    private static String APP_ID = "24043499";
    private static String API_KEY = "aVrNnWsrwttr5SnW3ynRGF04";
    private static String SECRET_KEY = "Ud9IEDI8XLAIsvKCTxghrnQv3nad1QNB";
